package com.example.expensoryapp.views
...
import com.example.expensoryapp.R
import com.example.expensoryapp.databinding.FragmentBusinessDetailBinding
import com.example.expensoryapp.databinding.FragmentLoginBinding
...
class BusinessDetailFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.btnAddBusiness.setOnClickListener {
            findNavController().navigate(R.id.action_businessDetailFragment_to_addBusinessFragment)
        }
